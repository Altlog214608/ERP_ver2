...
class Manufacturing_Order(tk.Frame):
    def __init__(self, root):
        ...
        self.Man_SOP_Code_input_f1 = ttk.Combobox(self.frame1,state=tk.DISABLED,width=18,values=self.sop_list)
        ...
        self.Man_Product_Code_f1 = tk.Label(self.frame1, text="자재 코드")
        ...
        self.Man_Product_Name_f1 =tk.Label(self.frame1, text="자재 이름")
    ...
    def recv(self,**kwargs):
        ...
        if kwargs.get("sign") ==1 and kwargs.get("code") == 20304:
            ...
            self.Man_SOP_Code_input_f1 = ttk.Combobox(self.frame1, width=18, values=self.sop_list)
            self.Man_SOP_Code_input_f1.place(x=self.frame_x[1], y=self.frame_y[1])
