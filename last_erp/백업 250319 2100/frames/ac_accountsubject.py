...
class AccountSubjectFrame(tk.Frame):
    ...
    def drawFrame(self):
        ...
        self.acNumLb = tk.Label(self.acControlFrame, text='계정코드구간', width=14)
        self.acNumLb.place(x=5, y=10)
        ...
        self.acTypeLb = tk.Label(self.acControlFrame, text='유형', width=14)
        self.acTypeLb.place(x=5, y=80)
