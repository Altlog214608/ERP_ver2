...
class DashboardFrame(tk.Frame):
    ...
    def recv(self, **kwargs):
        ...
        if data3 is not None:
            self.gr_bot_left.after(0, lambda a: self.gr_bot_left.draw_pie(data3, title="Top 5 Production Costs"), None)
        if data4 is not None:
            self.gr_bot_right.after(0, lambda a: self.gr_bot_right.draw_plot(data4, title="Top 5 Items with the Largest Cost Savings"), None)
