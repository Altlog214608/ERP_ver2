...
class TableWidget(tk.Frame):
    ...
    def from_data(self, data, cols = 0, new_row = True, has_checkbox = True,
        ...
        self.canvas.config(scrollregion=(0, 0, self.origin_cell_width + self.checkbox_cell_width + sum(self.col_widths), self.origin_cell_height + self.rows * self.cell_height))
