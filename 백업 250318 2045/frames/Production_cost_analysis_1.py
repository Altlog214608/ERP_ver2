...
class Production_cost_analysis_1(tk.Frame): #비용분석 - 1
    ...
    def __init__(self, root):
        ...
        self.test_btn1.grid(row=0, column=2, columnspan=2, padx=5, pady=10, sticky="e")  # column=2로 조정

        self.test_btn2 = ttk.Button(self.frame2, text="계정 과목 검색", command=self.on_serch)
        self.test_btn2.grid(row=1, column=2, columnspan=2, padx=5, pady=10, sticky="e")  # column=2로 조정
