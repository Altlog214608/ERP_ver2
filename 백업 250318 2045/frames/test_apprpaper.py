...
class ApprovalPaperFrame(tk.Frame):
    ...
    def managerAppr(self):
        ...
        self.req_name_txt = tk.Label(self.app_frame, text=self.data.get("name"), font=self.main_font)
        ...
        self.req_papar_content = tk.Label(self.app_frame, text=self.data.get("appr_type"),font=self.main_font)
        ...
        self.req_reason_content = tk.Label(self.app_frame, text=self.data.get("appr_contents"), font=self.main_font, wraplength=240, justify='left')
        self.req_reason_content.place(x=55, y=160)

        # self.sign = tk.Label(self.app_frame, text="O", font=self.main_font)
        for i in range(self.data.get("sign", 0)):
            sign = tk.Label(self.app_frame, text="O", font=self.main_font)
                ...
                data = {
                    ...
                    "args": {
                        ...
                        "msg": {
                            ...
                            "appr_contents": self.data.get("appr_type"),
                            "sign": sign + 1
                        }
                    }
                }
